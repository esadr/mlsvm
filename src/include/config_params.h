...
//    void check_input_prediction_parameters();
    ...
    void read_load_metis_parameters(pugi::xml_node& root, int argc, char * argv[]);
...
public:
    enum program_parts {main, convert_files, zscore, flann, svm, prediction, clustring, ld_metis} ;
